...
class AutoComplete:
    ...
    def try_open_completions_event(self, event):
        ...
        # simplification - see simplification of def fetch_completions
    ...
    def get_entity(self, name):
        ...
        namespace.update(__main__.__dict__)  # this seems to cut out the dictionary at the end of 'namespace'
